...
def all_supplies_in_holidays(holiday_hash)
  ...
  holiday_hash.each do |seasons, holidays|
    ...
    holidays.each do |holiday_name, supplies|
      ...
      if holiday_name.to_s.include?("_") == true
        ...
        holiday_capitalized = holiday_name_array.join(" ")
      else 
        holiday_capitalized = holiday_name.to_s.capitalize!
      end

      puts "  #{holiday_capitalized}: #{supplies.join(", ").to_s}"
    end
  end
end
